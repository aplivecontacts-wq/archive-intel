...
export const officialSourceGroups: SourceGroup[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        name: 'Justia',
        domain: 'justia.com',
        description: 'Free legal information, case law, codes, and legal research',
        directUrl: 'https://www.justia.com/',
        linkOnly: true,
        access: 'free',
      },
    ],
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        domain: 'house.gov',
        description: 'U.S. House of Representatives — representatives, committees, legislative activity, floor proceedings',
        directUrl: 'https://www.house.gov/',
        linkOnly: true,
      },
      {
        name: 'United States Senate',
        domain: 'senate.gov',
        description: 'U.S. Senate — senators, committees, legislation, votes, floor proceedings',
        directUrl: 'https://www.senate.gov/',
        linkOnly: true,
      },
      {
        name: 'Federal Election Commission',
        domain: 'fec.gov',
        description: 'Campaign finance data, filings, enforcement, and legal resources',
        directUrl: 'https://www.fec.gov/',
        linkOnly: true,
      },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        description: 'Stock quotes, market data, and financial news',
        directUrl: 'https://finance.yahoo.com',
        linkOnly: true,
      },
      {
        name: 'Seeking Alpha',
        domain: 'seekingalpha.com',
        description: 'Stock market analysis, earnings, and investor research (Premium content paywalled)',
        directUrl: 'https://seekingalpha.com/',
        linkOnly: true,
        access: 'paywalled',
      },
    ],
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        domain: 'archive.org',
        description: 'Digital library, web archive, and media collections',
      ...
      },
      {
        ...
        description: 'View cached and archived versions of web pages',
        directUrl: 'https://cachedview.com',
        linkOnly: true,
      },
    ],
  },
  ...
  {
    groupName: 'Corporate & Ownership Records',
    sources: [
      {
        name: 'OpenCorporates',
        domain: 'opencorporates.com',
        description: 'Global company database. Free for manual lookups; paid for bulk/API/commercial use.',
        directUrl: 'https://opencorporates.com',
        linkOnly: true,
        access: 'paywalled',
      },
      {
        ...
        description: 'Offshore leaks and cross-border investigations data',
        directUrl: 'https://offshoreleaks.icij.org',
        linkOnly: true,
      },
      {
        name: 'Violation Tracker',
        domain: 'violationtracker.goodjobsfirst.org',
        description: 'Corporate misconduct and enforcement penalties',
        directUrl: 'https://violationtracker.goodjobsfirst.org',
        linkOnly: true,
      },
      {
        name: 'CorporationWiki',
        domain: 'corporationwiki.com',
        description: 'Company profiles and corporate relationship mapping',
        directUrl: 'https://www.corporationwiki.com',
        linkOnly: true,
      },
      {
        name: 'LittleSis',
        domain: 'littlesis.org',
        description: 'Power mapping and influence research',
        directUrl: 'https://littlesis.org',
        linkOnly: true,
      },
    ],
  },
  {
    groupName: 'Media & Broadcast Archives',
    sources: [
      {
        name: 'Vanderbilt Television News Archive',
        domain: 'tvnews.vanderbilt.edu',
        description: 'TV news abstracts free; full video paywalled',
        directUrl: 'https://tvnews.vanderbilt.edu',
        linkOnly: true,
        access: 'paywalled',
      },
      {
        ...
        domain: 'c-span.org',
        description: 'C-SPAN video archive and congressional coverage',
        directUrl: 'https://www.c-span.org',
        linkOnly: true,
      },
      {
        name: 'Getty Images',
        domain: 'gettyimages.com',
        description: 'Stock photography and editorial images',
        directUrl: 'https://www.gettyimages.com',
        linkOnly: true,
      },
    ],
  },
  {
    groupName: 'Research & OSINT Tools',
    sources: [
      {
        name: 'DeDigger',
        domain: 'dedigger.com',
        description: 'Document and file discovery search',
        directUrl: 'https://www.dedigger.com',
        linkOnly: true,
      },
      {
        name: 'Archive.today',
        domain: 'archive.today',
        description: 'Web page archiving and snapshot tool',
        directUrl: 'https://archive.today',
        linkOnly: true,
      },
      {
        name: 'ExifTool',
        domain: 'exiftool.org',
        description: 'Photo metadata extraction and verification',
        directUrl: 'https://exiftool.org',
        linkOnly: true,
      },
      {
        name: 'FotoForensics',
        domain: 'fotoforensics.com',
        description: 'Image analysis and manipulation detection',
        directUrl: 'https://fotoforensics.com',
        linkOnly: true,
      },
    ],
  },
  {
    groupName: 'Satellite & Geo',
    sources: [
      {
        name: 'Google Earth',
        domain: 'earth.google.com',
        description: 'Satellite imagery and geographic exploration',
        directUrl: 'https://earth.google.com',
        linkOnly: true,
      },
      {
        name: 'SunCalc',
        domain: 'suncalc.org',
        description: 'Sun position and sunlight phases for any location',
        directUrl: 'https://suncalc.org',
        linkOnly: true,
      },
      {
        name: 'Sentinel Hub',
        ...
        directUrl: 'https://www.sentinel-hub.com',
        linkOnly: true,
        access: 'paywalled',
      },
    ],
